...
<body>
    <div class="container p-0 m-0" style="height: 100%;max-width:none !important">
        <div class="row m-0" style="width:100%;height:100%;">
            <div class="col-12 col-sm-12 col-md-12 col-lg-4 px-4 py-2">
                ...
                <div class="px-3">
                        ...
                        <div class="row d-flex justify-content-center mb-1 mx-0">
                            <div class="col-12">
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" id="ordinary" aria-describedby="emailHelp"
                                        style="height: 27px;" value="{{ $dataFix['idUmat'] }}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row d-flex justify-content-center mb-1 mx-0">
                            <div class="col-12">
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" id="ordinary" aria-describedby="emailHelp"
                                        style="height: 27px;" value="{{ $dataFix['namaUmat'] }}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row d-flex justify-content-center mb-1 mx-0">
                            <div class="col-12">
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" id="ordinary" aria-describedby="emailHelp"
                                        style="height: 27px;" value="{{ $dataFix['relasi'] }}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row d-flex justify-content-center mb-1 mx-0">
                            <div class="col-12">
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" id="ordinary" aria-describedby="emailHelp"
                                        style="height: 27px;" value="{{ $dataFix['namaleluhur'] }}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row d-flex justify-content-center mb-1 mx-0">
                            <div class="col-12">
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" id="ordinary" aria-describedby="emailHelp"
                                        style="height: 27px;" value="{{ $dataFix['tanggalmeninggal'] == '' ? '-' : $dataFix['tanggalmeninggal'] }}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row d-flex justify-content-center mb-1 mx-0">
                            <div class="col-12">
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" id="ordinary" aria-describedby="emailHelp"
                                        style="height: 27px;" value="{{ $dataFix['transaksiterakhir'] }}" readonly>
                                </div>
                            </div>
                        </div>
                        {{-- peridoe GK D PAKE --}}
                    ...
                    <div class="row d-flex justify-content-center mb-1 mt-4 mx-0 pe-lg-3">
                        <div class="col-12">
                            <div class="mb-2">
                                <button type="button" class="btn btn-secondary btn-sm btn-7"
                                    style="width:100%;" id="PESANFOTO">PESAN</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- KANAN -->
            <div class="col-12 col-sm-12 col-md-12 col-lg-8 d-flex justify-content-center p-3 "
...
//   $( "p" ).removeClass( "myClass noClass" ).addClass( "yourClass" );
        ...
        $(document).ready(function() {
            ...
            $('#PESANFOTO').on('click',function(){
                ...
                const obj = JSON.parse(text);
                console.log(obj);
                console.log("LOKASI: "+STAT + " "+CODELOKASI);
                if(STAT==0 &&CODELOKASI!="")
                {
                    $.ajax({
                    type:'post',
                    url:'/data-leluhur/PESANFOTOLOKASI',
                    data: {
                        "_token": "{{ csrf_token() }}",
                        kode: obj
                    },
                        success:function(data) {
                            ...
                            ({
                                ...
                                text: data['nama_mendiang']+' berhasil di pesan.',
                                icon: 'success',
                                timer: 2000,
                            ...
                            console.log(data);
                            window.location.replace('/data-leluhur/pesan-pas-foto');
