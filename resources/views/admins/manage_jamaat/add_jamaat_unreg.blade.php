            ...
            <ul class="nav nav-tabs justify-content-center">
                <li class="nav-item">
                    <a class="nav-link" style="color: #000000;"
                        href="{{ url('kelola-jamaat/tambah-jamaat') }}">Umat Terdaftar</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active disabled" aria-current="page" href="#">Umat Tidak Terdaftar</a>
                </li>
            </ul><br>
            <form action="{{ url('kelola-jamaat/i-tambah-jamaat-unreg') }}" method="POST">
                @csrf
                <div class="card mb-5">
                        ...
                        <div class="container-fluid row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="no_handphone_kerabat" value="{{ old('no_handphone_kerabat') }}"
                                    ...
                                    title="Input harus angka 0-9!" aria-describedby="emailHelp" >
                            </div>
                            <div class="col-12">
                                <label for="exampleFormControlTextarea1" class="form-label">Alamat </label>
