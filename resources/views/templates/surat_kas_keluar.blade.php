    ...
    <div class="container-xl">
        <table style="width:100%;">
            <tr>
                ...
                <td style="width: 5%; text-align: left; vertical-align:top;">Tanggal</td>
                <td style="width: 35%; text-align: left; vertical-align:top;">
                    : {{ \Carbon\Carbon::createFromFormat('Y-m-d', $data_kas_keluar->tanggal)->format('d-m-Y') }}
                </td>
            </tr>
            <tr>
                ...
                <td style="text-align: left; vertical-align:top;">Admin</td>
                <td style="text-align: left; vertical-align:top;">: {{ $data_kas_keluar->nama_admin }}</td>
            </tr>
            <tr>
                <td rowspan="2" style="text-align:left;vertical-align:top;">
                    <strong>Surabaya</strong>
                </td>
                <td style="text-align: left; vertical-align:top;">Nomer</td>
                <td colspan="2"style="text-align: left; vertical-align:top;">: {{ $data_kas_keluar->nomor_kas_keluar }}</td>
            </tr>
            <tr>
                <td style="text-align: left; vertical-align:top;">Kepada</td>
                <td style="text-align: left; vertical-align:top;">: {{ $data_kas_keluar->penerima }}</td>
            </tr>
        </table>
        <br>
        <table style="width: 100%">
            ...
            <tr class="txt-list">
                ...
                <td colspan="2" style="text-align:center;border: solid 1px #333333">
                    {{ $data_kas_keluar->keterangan_keperluan }}</td>
                <td style="text-align:center;border: solid 1px #333333">Rp.
                    {{ number_format($data_kas_keluar->nominal_pengeluaran, 2, ',', '.') }}</td>
            </tr>
            <tr class="txt-list">
...
<script>
    ...
    // if (document.referrer == "{{ url('kas/laporan-kas-keluar') }}") {
    // }
    // else if (document.referrer == "{{ url('kas/kas-keluar') }}") {
    //     window.onafterprint = back;
    // }

    function back() {
        window.location.replace("{{ url('kas/kas-keluar') }}");
    }
</script>
</html>
