...
<body>
    <div class="container-xl box">
        <div class="column">
            <img src="{{ public_path('images/app_admin/dashboard/atas-bawah.png') }}" class="rounded" style="height: auto; width: 32%">
        ...
        <div class="rapi txt" style="border-bottom: 1px solid;">
            <table style="width: 100%;">
                ...
                <tr>
                    <td><img src="{{ public_path('images/qrcode_terima_kasih.png') }}" alt="" style="height: 75px; width: 75px; margin-left: 50px;"></td>
                </tr>
                <br>
            </table>
        </div>
