...
class LaporanKeuanganController extends Controller
{
    ...
    public function showDataTransaksi_($year_month = 0)
    {
        ...
        $total_pengeluaranTu = KasKeluar::whereBetween('tanggal', [$min_YM, $max_YM])->where('diberikan_secara', '=', 'Tunai')->sum('nominal_pengeluaran');
        $total_pengeluaranTf = KasKeluar::whereBetween('tanggal', [$min_YM, $max_YM])->where('diberikan_secara', '=', 'Transfer')->sum('nominal_pengeluaran');
        ...
        $total_pemasukkan_tunai = $transaksi_dana_tunai + $transaksi_paket_tunai + $transaksi_foto_tunai + $kas_masuk;
        ...
        $laba_bersih = $total_pemasukkan_tunai - $total_pengeluaran;
