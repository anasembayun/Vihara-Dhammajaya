                        ...
                        <div class="iq-card-body">
                            ...
                            <form>
                                ...
                                <div class="row form-group">
                                    <div class="col-sm">
                                    <div class="input-group">
                                            <input type="password" id="" class="form-control" placeholder="Masukkan Password Terakhirmu">
                                        </div>
                                    </div>
                                </div>
                                <div class="row form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm" style="text-align:left; color:yellow;">
                                        Jawab Pertanyaan Dibawah Ini Sesuai Awal Membuat Akun Dengan Email Diatas
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-sm">
